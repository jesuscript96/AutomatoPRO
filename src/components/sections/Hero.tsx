  ...
  return (
    ...
    >
      <div className="relative w-full h-full flex flex-col">
        ...
        <div className="relative w-full h-[calc(100%/9)] border-b border-black flex items-center px-6 md:px-8">
          <motion.div
        ...
        {/* Fila 2 - TU WEB */}
        <div className="relative w-full h-[calc(100%/9)] border-b border-black flex items-center px-[20%]">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="relative w-full h-[calc(100%/9)] border-b border-black flex items-center justify-between px-[20%]">
          <div className="flex-1"></div>
          <motion.div
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.8, delay: 0.4, ease: [0.22, 1, 0.36, 1] }}
            className="w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] md:w-[280px] md:h-[280px] lg:w-[320px] lg:h-[320px] xl:w-[360px] xl:h-[360px] bg-white border border-black z-20"
            style={{
        ...
        {/* Fila 4 - "ESCAPARATE" */}
        <div className="relative w-full h-[calc(100%/9)] border-b border-black flex items-center justify-end px-[20%]">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="relative w-full h-[calc(100%/9)] border-b border-black flex items-center justify-center px-[20%]">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            ...
            className="absolute right-[25%] w-[160px] h-[160px] sm:w-[200px] sm:h-[200px] md:w-[240px] md:h-[240px] lg:w-[280px] lg:h-[280px] bg-white border border-black z-20"
            style={{
              boxShadow: '2px 2px 0px 0px rgba(0, 0, 0, 0.1), 4px 4px 0px 0px rgba(0, 0, 0, 0.05)',
            }}
          />
